from vendas_backend.adm.choices import SITUACAO_VENDA_CHOICES
...
class Venda(models.Model):
    ...
    vendedor = models.ForeignKey(Vendedor, blank=True, null=True, verbose_name='Vendedor')
...
class ItemVenda(models.Model):
    ...
    produto_servico = models.ForeignKey(ProdutoServico, verbose_name='Produto/Serviço')
